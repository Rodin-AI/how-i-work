...
The checklist above tells you WHAT to document. For the full guide on HOW to write each type — domain glossaries, conventions, reference patterns, ecosystem pattern repos — and how to keep them alive as the codebase evolves, see:

→ **[Building Reference Documentation](building-reference-docs.md)**

That page covers concrete examples, templates, common mistakes, time estimates, and the maintenance discipline that prevents docs from going stale.
