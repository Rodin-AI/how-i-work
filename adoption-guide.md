...
## How to write each type of documentation

You know WHAT to document (the checklist above) and WHERE it goes (the file structure below). This section covers HOW to actually write each piece — what a good one looks like, how to produce it, and common mistakes.
...
3. For each one, write a 1-2 sentence definition that answers: "If a new developer asked 'what's a [term]?', what would you say?"
...
### Ecosystem reference docs (pattern repos)
...
### Where each type lives (summary)

| Type | Location | Scope | Survives a rewrite? |
|------|----------|-------|--------------------|
| Domain glossary | `your-project/docs/domain/glossary.md` | This project | Yes |
| Conventions | `your-project/CONVENTIONS.md` | This project | Partially |
| Reference patterns | `your-project/docs/domain/<pattern>.md` | This project | Yes |
| Ecosystem patterns | `your-org/<lang>-patterns/` (separate repo) | All projects in that language | Yes |
| Implementation docs | `your-project/docs/impl/<topic>.md` | This project | No |
| Feature designs | `your-project/docs/designs/<feature>.md` | This project | Partially |

**The stability test:** "Would this fact survive a complete rewrite of the internals?"
- Yes → domain docs
- No → implementation docs
- Maybe → conventions (they're partially stable — the WHAT survives, the HOW might change)
