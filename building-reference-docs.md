...
→ **[See complete example](examples/domain-glossary.md)**
...
→ **[See complete example](examples/conventions.md)**
...
→ **[See complete example](examples/reference-pattern.md)**
...
→ **[See complete example](examples/ecosystem-pattern.md)**
